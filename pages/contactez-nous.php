...
<body class="bg-white">
      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-2xl animate-slide-left">
        <div class="py-10 px-8 md:px-14">
          ...
          <div id="panel-1" class="step-panel">
            ...
            <h2 class="text-3xl font-bold text-[#244163] mb-3">Vos informations</h2>
            ...
            <div class="space-y-5">
              ...
              <div>
                ...
                <input id="f-tel" type="tel" placeholder="+33 (0)6 00 00 00 00"
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 bg-gray-50 transition-all duration-300"/>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input id="f-ville" type="text" placeholder="Grenoble, Chambéry..."
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 bg-gray-50 transition-all duration-300"/>
                </div>
              </div>
          ...
          <div id="panel-2" class="step-panel hidden">
            ...
            <h2 class="text-3xl font-bold text-[#244163] mb-3">Votre besoin</h2>
            ...
            <div class="space-y-5">
              ...
              <div>
                ...
                <div class="grid grid-cols-3 sm:grid-cols-6 gap-2" id="sectors-grid">
                  ...
                  <div class="sector-card border border-gray-200 rounded-lg py-3 px-2 text-center bg-white" data-val="Tourisme" onclick="pickSector(this)">
                    <div class="flex justify-center mb-1">
                      <svg class="w-5 h-5 text-[#1a7e6c]" viewBox="0 0 24 24" fill="none" stroke="#1a7e6c" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <div class="sector-card border border-gray-200 rounded-lg py-3 px-2 text-center bg-white" data-val="Syndic" onclick="pickSector(this)">
                    <div class="flex justify-center mb-1">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#1a7e6c" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>
                      </svg>
                    </div>
                    <p class="text-[9px] text-[#244163] font-bold uppercase tracking-[0.4px]">Syndic</p>
                  </div>
 
                  <div class="sector-card border border-gray-200 rounded-lg py-3 px-2 text-center bg-white" data-val="Tertiaire" onclick="pickSector(this)">
                    <div class="flex justify-center mb-1">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#1a7e6c" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <div class="sector-card border border-gray-200 rounded-lg py-3 px-2 text-center bg-white" data-val="Industrie" onclick="pickSector(this)">
                    <div class="flex justify-center mb-1">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#1a7e6c" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <div class="sector-card border border-gray-200 rounded-lg py-3 px-2 text-center bg-white" data-val="Désinfection" onclick="pickSector(this)">
                    <div class="flex justify-center mb-1">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#1a7e6c" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <div class="sector-card border border-gray-200 rounded-lg py-3 px-2 text-center bg-white" data-val="Travaux Publics" onclick="pickSector(this)">
                    <div class="flex justify-center mb-1">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#1a7e6c" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div id="panel-3" class="step-panel hidden">
            ...
            <div class="mb-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                <div class="recap-card bg-gray-50 border border-gray-200 rounded-lg border-l-2 border-l-[#1a7e6c] pl-3 pr-2 py-2">
                  <p class="text-[9px] text-[#1a7e6c] uppercase tracking-[1px] font-bold mb-1">Fréquence</p>
                  <p id="r3-frequence" class="text-[12px] text-[#244163] font-medium">—</p>
                </div>
                <div class="recap-card bg-gray-50 border border-gray-200 rounded-lg border-l-2 border-l-[#1a7e6c] pl-3 pr-2 py-2">
            ...
            <h2 class="text-3xl font-bold text-[#244163] mb-3">Confirmation</h2>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-start gap-3 bg-[#1a7e6c]/6 border border-[#1a7e6c]/20 rounded-lg p-4">
                <div class="w-8 h-8 rounded-md bg-[#1a7e6c]/12 flex items-center justify-center shrink-0 mt-0.5">
 ...
 <script>
    // Valeur PHP du secteur sélectionné (tourisme, syndic, tertiaire, industriel, desinfection, tp)
    let sectorVal = '';
    // Label lisible pour les recaps visuels
    const sectorLabels = {
      tourisme:    'Tourisme',
      syndic:      'Syndic',
      tertiaire:   'Tertiaire',
    ...
    function fillRecap1() {
      ...
      const societe = document.getElementById('f-societe').value || '—';
      const email   = document.getElementById('f-email').value   || '—';
      const ville   = document.getElementById('f-ville').value   || '—';
      ['r1','r3'].forEach(prefix => {
        const el1 = document.getElementById(prefix + '-prenom');
        const el2 = document.getElementById(prefix + '-societe');
        const el3 = document.getElementById(prefix + '-email');
        const el4 = document.getElementById(prefix + '-ville');
        if (el1) el1.textContent = prenom;
        if (el2) el2.textContent = societe;
        if (el3) el3.textContent = email;
        if (el4) el4.textContent = ville;
      });
    }
 
    function fillRecap2() {
      const message  = document.getElementById('f-message').value   || '—';
      const frequence = document.getElementById('f-frequence').value || '—';
      document.getElementById('r3-secteur').textContent   = sectorLabels[sectorVal] || '—';
      document.getElementById('r3-frequence').textContent = frequence;
    ...
    async function submitForm() {
      ...
      // Société + ville + fréquence intégrés dans le message (champs non prévus par le PHP)
      const messageComplet = [
        messageBase,
        societe  ? 'Société : '   + societe   : '',
        ville    ? 'Ville : '     + ville     : '',
        frequence ? 'Fréquence : ' + frequence : '',
      ].filter(Boolean).join('\n');
 
      // Construction du FormData — noms de champs identiques au PHP
      const data = new FormData();
      data.append('prenom',  prenom);
      data.append('nom',     nom);
      data.append('email',   email);
      data.append('tel',     tel);
      data.append('service', sectorVal);   // valeur PHP : tourisme, syndic, etc.
