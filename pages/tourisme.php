      ...
      <div class="relative z-10 flex-1 max-w-7xl mx-auto w-full pl-10 pr-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center pb-12">
        ...
        <div class="flex flex-col">
          ...
          <div class="flex gap-3 flex-wrap">
            <a href="#prestations" class="inline-flex items-center gap-2 bg-[#e8f5f2] text-[#1a7e6c] font-semibold text-sm px-6 py-3.5 rounded-[10px] border border-[#c2e8df] transition-all duration-200 hover:bg-[#1a7e6c] hover:text-white hover:border-[#1a7e6c] hover:-translate-y-0.5">
...
const prestData = [
  ...
  { num:"02", title:"Dégraissage", desc:"Traitement intensif de toutes les surfaces, traitées avec des produits dégraissants, à vapeur homologués pour éliminer les incrustations tenaces et les odeurs persistantes.", tags:["Taitement intensif","Produits pro","Fin et début de saison"], checks:["Désinfection de la salle de bains","Dégraissage intensif de toutes les parties de la cuisine","Traitement des sols et murs","Nettoyage des surfaces extérieurs (vitres, volets, rideaux, terasses)","Désinfection des poignées et surfaces de contact","Élimination des odeurs résiduelles"] },
